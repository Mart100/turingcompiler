...
FIND_B_END (0,1,StartA,ABsep,MovH0,MovH1) * R FIND_B_END
...
CHECK_B MulH *  L CHECK_B
CHECK_B 0 MulH  R SHIFT_C
CHECK_B 1 MulH  R ADD_C_TO_A_0
CHECK_B ABsep * R CLEAR_B

## Multiply C by shifting each bit to the left

# First go to end of C
SHIFT_C (0,1,MulH,EndB) *   R SHIFT_C
...
# First go to end of C
ADD_C_TO_A_0 (0,1,ABsep,EndB,MovH0,MovH1,MulH) *    R ADD_C_TO_A_0
ADD_C_TO_A_0 EndC *                                 L ADD_C_TO_A_1

# Find first non-moved digit of C, and replace 0 with MovH0 and 1 with MovH1
ADD_C_TO_A_1 0 MovH0            L ADD_C_TO_A_ZERO
ADD_C_TO_A_1 1 MovH1            L ADD_C_TO_A_ONE
ADD_C_TO_A_1 (MovH0,MovH1) *    L ADD_C_TO_A_1
ADD_C_TO_A_1 EndB *             R ADD_C_TO_A_RESTORE_0

# Move a 0 from C to end of A
ADD_C_TO_A_ZERO (0,1,EndB,MovH0,MovH1,MulH) *   L ADD_C_TO_A_ZERO
ADD_C_TO_A_ZERO ABsep *                         L ADD_C_TO_A_ZERO_1

# Set the 0 in A to MovH0, except if its a 1
ADD_C_TO_A_ZERO_1 MovH0 *   L ADD_C_TO_A_ZERO_1
ADD_C_TO_A_ZERO_1 MovH1 *   L ADD_C_TO_A_ZERO_1
ADD_C_TO_A_ZERO_1 0 MovH0   R ADD_C_TO_A_0
ADD_C_TO_A_ZERO_1 1 MovH1   R ADD_C_TO_A_0

# Move a 1 from C to end of A
ADD_C_TO_A_ONE (0,1,EndB,MovH0,MovH1,MulH) *    L ADD_C_TO_A_ONE
ADD_C_TO_A_ONE ABsep *                          L ADD_C_TO_A_ONE_1

# Set the 1 in A to MovH1, unless if its already a 1
ADD_C_TO_A_ONE_1 MovH0 *    L ADD_C_TO_A_ONE_1
ADD_C_TO_A_ONE_1 MovH1 *    L ADD_C_TO_A_ONE_1
ADD_C_TO_A_ONE_1 0 MovH1    R ADD_C_TO_A_0
ADD_C_TO_A_ONE_1 1 MovH0    L ADD_C_TO_A_ONE_1_MOVE
...
ADD_C_TO_A_RESTORE_0 MovH0 0    R ADD_C_TO_A_RESTORE_0
ADD_C_TO_A_RESTORE_0 MovH1 1    R ADD_C_TO_A_RESTORE_0
ADD_C_TO_A_RESTORE_0 EndC  *    L ADD_C_TO_A_RESTORE_1

# Move to the start of A
ADD_C_TO_A_RESTORE_1 (0,1,ABsep,EndB,MovH0,MovH1,MulH) *    L ADD_C_TO_A_RESTORE_1
ADD_C_TO_A_RESTORE_1 StartA *                               R ADD_C_TO_A_RESTORE_2

# Restore the number in A, and move to the end of B
ADD_C_TO_A_RESTORE_2 (0,1,MulH,ABsep) *     R ADD_C_TO_A_RESTORE_2
ADD_C_TO_A_RESTORE_2 MovH0 0                    R ADD_C_TO_A_RESTORE_2
ADD_C_TO_A_RESTORE_2 MovH1 1                    R ADD_C_TO_A_RESTORE_2
ADD_C_TO_A_RESTORE_2 EndB *                     L SHIFT_C

# Clear B, set all to 0
CLEAR_B MulH 0   R CLEAR_B
